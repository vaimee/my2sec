...
|| DATE: 4/11/2022
############################################*/
class UserSynchronousConsumer extends Consumer{
  constructor(jsap_file,queryname,sub_bindings,flagname,flagUser,ignore_first_results,reset_synch_flag){
  ...
  async subscribeToSepa(){
    ...
    this.newSubRouter("GET_USER_SYNCHRONIZATION_FLAG",{
        flag_type:this.flagname,
        usergraph: this.flagUser
    },"onSyncFlag")
  }
  //EMIT SYNCH EVENT
  onSyncFlag(bind){
    this.log.debug("Flag received, user: "+this.flagUser)
