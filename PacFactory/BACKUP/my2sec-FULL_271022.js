jsappe={
	...
	"updates": {
		"TEST_INSERT_DATA_2":{
			"sparql": "INSERT DATA {<http://www.vaimee.it/my2sec/defuser@vaimee.it> opo:username 'defuser'}"
		},
		"TEST_INSERT_DATA":{
			"sparql": "INSERT DATA { GRAPH <http://www.vaimee.it/my2sec/members> {<http://www.vaimee.it/my2sec/gregorio.monari@vaimee.it> opo:username 'greg' }}"
		},
