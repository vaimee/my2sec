...
class AwValidatedActivitiesConsumer extends SynchronousConsumer{
    constructor(jsap,_activities_graph,_validatedActivitiesFlag){
        super(jsap,"ALL_USERS_VALIDATED_ACTIVITIES",{
            activities_graph:_activities_graph
          },_validatedActivitiesFlag,false)
    }
...
module.exports=AwValidatedActivitiesConsumer
