...
class MongoDbMessagesConsumer extends CachedConsumer{
    constructor(jsap){
    ...
    get_cache_by_usergraph(usergraph){
        var bindings=this.get_cache().get(usergraph)
        return bindings
    }
...
module.exports=MongoDbMessagesConsumer;