...
class AtAggregatorTester extends TestFactory{
    constructor(jsap){
        ...
        var testGraphs=[
            ...
            "http://vaimee.it/my2sec/events/developer",
            "http://vaimee.it/my2sec/activities/developer",
            "http://vaimee.it/my2sec/activities"
        ];
        var testFlags=[
            "http://www.vaimee.it/my2sec/awmongoproducerflag",
            "http://www.vaimee.it/my2sec/awmapperflag/developer",
            "http://www.vaimee.it/my2sec/trainingactivitiesflag/developer",
            "http://www.vaimee.it/my2sec/validatedactivitiesflag/developer",
        ...
        //this.log.loglevel=1;
        this.awMessagesProducer= new AwMessagesProducer(jsap,"http://www.vaimee.it/my2sec/gregorio.monari@vaimee.it")//new AwProducerTest(jsap);
        //Configure awTrainingActivitiesConsumer and flag remover
        var _activities_graph="http://vaimee.it/my2sec/activities/developer"
        var _trainingActivitiesFlag="http://www.vaimee.it/my2sec/trainingactivitiesflag/developer";
        ...
        var email="gregorio.monari@vaimee.it"
    ...
    async on_training_activities(flagbind){
        ...
        */
        ...
        for(var i in activities){
            ...
            var validated={
                activities_graph:"http://vaimee.it/my2sec/activities/developer",
        ...
        var activitiesresponse=await this.SET_SYNCHRONIZATION_FLAG({
            flag_type:"http://www.vaimee.it/my2sec/validatedactivitiesflag/developer",
            usergraph:flagbind.usergraph
        })
